...
function myFunction2() {
	...
	document.getElementById("demo2").innerHTML = " Day you picked is: " + y +typeof(y) + "   "  + r;
	...
	/*if (document.getElementById("forms2").elements[0].checked == true){
		...
		var checking = d.getDate()+100;

        var test1 = new Date (y).getTime();


		document.getElementById("demo2").innerHTML = " Number of days to pass: "+ numOfDays + " Your end date: " + lastDate + "  " + test1;


		
		//document.getElementById("demo2a").innerHTML = " trial "+ test1 + typeof(test1); 
